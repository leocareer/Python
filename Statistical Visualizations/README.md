...
- `Data:` .csv data files and equivalent database dump
- `1_statistical_visualizations.ipynb:` ...
- `2_scripts_for_powerbi.ipynb:` ...
- `3_powerbi_sql_python.pbix:` the Power BI report
- `4_powerbi_sql_python.pdf:` the Power BI report in .pdf
